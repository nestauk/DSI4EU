...
class ApproveWaitingApprovalTest extends PHPUnit_Framework_TestCase
{
    ...
    /** @test */
    public function canApproveWaitingApprovalProject()
    {
        ...
        (new \DSI\UseCase\WaitingApproval\ApproveWaitingApproval())
        ...
        $this->assertFalse($projects[0]->isWaitingApproval());
    }
    ...
    public function canApproveWaitingApprovalOrganisation()
    {
        ...
        $this->assertCount(1, $organisations);
        $this->assertCount(0, $contentUpdates);
        $this->assertFalse($organisations[0]->isWaitingApproval());
    }
}