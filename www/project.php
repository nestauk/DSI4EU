                                ...
                                <div class="w-clearfix current-status">
                                    ...
                                    <div class="post-author latest">
                                        ...
                                        <div class="post-author-detail latest"
                                             ng-bind="project.posts[0].user.name"></div>
                                    ...
                                    <div class="comment">
                                        <div class="w-row">
                                            ...
                                            <div class="w-col w-col-11">
                                                <div class="post-comment">
                                                    <div class="w-form">
                                                        <form ng-submit="submitComment(project.posts[0])">
                                                            <input type="text" placeholder="Write your comment"
                                                                   class="w-input add-comment" ng-model="project.posts[0].newComment">
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="w-row comment-original">
                                            ...
                                            <div class="w-col w-col-8">
                                                <div class="post-comment comment-original-post">Please could you explain
                                            ...
                                            <div class="w-row reply-cols">
                                                ...
                                                <div class="w-col w-col-9">
                                                    <div class="post-comment reply-comment">Yes, I too would like to
                                                        know the cost of this. I would also like to ask why you thought
                                                    ...
                                                    <div class="w-form">
                                                        <form id="email-form" name="email-form" data-name="Email Form">
                                                            <input id="Comment-5" type="text"
                                                                   ...
                                                                   data-name="Comment 5" class="w-input add-comment">
                                                        </form>
