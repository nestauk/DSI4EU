    ...
    <div class="content-directory">
        <div class="container-wide">
             ...
             <div class="page-info-block update-card w-clearfix" data-ix="edit-update">
                ...
                <div class="update-date">10th October 2016</div>
                <h4>DSI4EU Website update</h4>
                <p>Digitalsocial.eu has undergone a complete overhaul.</p>
            ...
            <div class="page-info-block update-card w-clearfix" data-ix="edit-update">
                ...
                <h4>Updates page</h4>
                <p>Updates page has been added to keep users up to date with new features, bug fixes and updates to existing features.
...
<!--
            <div class="page-info-block update-card w-clearfix" data-ix="edit-update">
                ...
                <h4>Create project - Screen no longer scrolls back to top after entering your name</h4>
