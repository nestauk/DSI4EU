    ...
    <div class="content-block">
        <div class="w-row">
            <div class="w-col w-col-8">
                ...
                <p class="intro">If you have got any questions about the DSI4EU research and website, please don’t
                    hesitate to get in touch. You can drop us an email on contact@digitalsocial.eu.&nbsp;</p>
                <p>If you have got feedback on the website please complete the
