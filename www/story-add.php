<?php require __DIR__ . '/header.php' ?>
    ...
    <script type="text/javascript"
            src="<?php echo SITE_RELATIVE_PATH ?>/js/controllers/AddStoryController.js"></script>
                    ...
                    <form class="w-clearfix" ng-submit="addStory()">
                        <div class="w-row">
                            <div class="w-col w-col-6">
                                ...
                                <input type="text" style="display:none" id="datePublished" maxlength="256" ng-model="datePublished">
                                <br/><br/>
                                ...
                                <div class="w-checkbox">
                                    <input class="w-checkbox-input" data-name="Checkbox" id="checkbox" name="checkbox"
                                           type="checkbox">
                                    <label class="w-form-label" for="checkbox">News</label>
                                </div>
                                <div class="w-checkbox">
                                    <input class="w-checkbox-input" data-name="Checkbox 3" id="checkbox-3"
                                           name="checkbox-3"
                                           type="checkbox">
                                    <label class="w-form-label" for="checkbox-3">Events</label>
                                </div>
                                <div class="w-checkbox">
                                    <input class="w-checkbox-input" data-name="Checkbox 2" id="checkbox-2"
                                           name="checkbox-2"
                                           type="checkbox">
                                    <label class="w-form-label" for="checkbox-2">Case studies</label>
                                </div>
                            </div>
                            <div class="w-col w-col-6">
                                ...
                                <div class="w-checkbox">
                                    <input class="w-checkbox-input" data-name="Checkbox 5" id="checkbox-5"
                                           name="checkbox-5"
                                           type="checkbox">
                                    <label class="w-form-label" for="checkbox-5">Published</label>
                                </div>
                                <div class="w-checkbox">
                                    <input class="w-checkbox-input" data-name="Checkbox 4" id="checkbox-4"
                                           name="checkbox-4"
                                           type="checkbox">
                                    <label class="w-form-label" for="checkbox-4">Unpublished</label>
                                </div>
                            </div>
                        </div>
                        <input class="w-button dsi-button post-story" data-wait="Please wait..." type="submit"
                               value="Post story">
                        <input class="w-button dsi-button post-story cancel" data-wait="Please wait..." type="submit"
                               value="Save">
                        <input class="w-button dsi-button post-story cancel" data-wait="Please wait..." type="submit"
                               value="Cancel">
                    </form>
