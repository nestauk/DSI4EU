...
/** @var \DSI\Entity\Project $project */
...
<p>We wanted to let you know that we’ve approved the project you added to our website and it is now
    public on
    <a href="<?= $urlHandler->fullUrl($urlHandler->home()) ?>">digitalsocial.eu</a>.
    You can access it here:
    <a href="<?= $urlHandler->fullUrl($urlHandler->project($project)) ?>"><?= $urlHandler->fullUrl($urlHandler->project($project)) ?></a>.
</p>
