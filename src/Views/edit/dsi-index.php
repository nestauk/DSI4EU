...
<div class="edit-open-data-controller" ng-controller="EditDsiIndexController">
    <div class="content-block">
        <div class="w-row">
            <div class="w-col w-col-8">
                <?php /* <h1 class="content-h1"><?php _ehtml('Open data, research & resources') ?></h1> */ ?>
                <h1 class="content-h1"><?php _ehtml('DSI Index') ?></h1>
...
<script type="text/javascript"
        src="/js/controllers/EditDsiIndexController.js?<?php \DSI\Service\Sysctl::echoVersion() ?>"></script>
